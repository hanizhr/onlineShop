...
class CartItem extends StatelessWidget {
  const CartItem(
      ...
      required this.onIncreasButtomClick,
      required this.onDecreasButtomClick})
      : super(key: key);

  final CartItemEntity data;
  final GestureTapCallback onDeleteButtonClick;
  final GestureTapCallback onIncreasButtomClick;
  final GestureTapCallback onDecreasButtomClick;
  @override
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          onPressed: onIncreasButtomClick,
                          icon: const Icon(CupertinoIcons.plus_rectangle),
                        ),
                        data.changCountLoading
                        ...
                        IconButton(
                          onPressed: onDecreasButtomClick,
